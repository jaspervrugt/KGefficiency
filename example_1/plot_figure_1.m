...
%,'FontWeight','bold');
hh.LevelList = [50 52 55 60 70 80 100 125 150 200 250]; colormap(copper)
...
if text_perct == 1
    ...
    text(ax1,xmax-0.035*(xmax-xmin),ls_95(2,2)-6*0.0004,'${\rm 97.5\%}$',...
        'interpreter','latex','fontsize',fontsize_percentiles,...
        'HorizontalAlignment', 'right','color',unif_intervals);
end
...
line(ax1,[ls_95(1,1) ls_95(1,1)],[ls_95(2,1) ls_95(2,2)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
line(ax1,[ls_95(1,2) ls_95(1,2)],[ls_95(2,1) ls_95(2,2)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
% optimum solution
...
dy = ymin - 0.065*(ymax-ymin);
for rr = 1:numel(xtick)
    text(ax2,xtick(rr),dy,xticklabel(rr),'fontsize',fontsize_axis, ...
        'HorizontalAlignment', 'center');
end
...
line(ax2,[xmin xmin + 0.03*(xmax-xmin)],[bs_95(2,2) bs_95(2,2)], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
line(ax2,[xmax xmax - 0.03*(xmax-xmin)],[bs_95(2,1) bs_95(2,1)], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
line(ax2,[xmax xmax - 0.03*(xmax-xmin)],[bs_95(2,2) bs_95(2,2)], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
% add text about percentiles
if text_perct == 1
...
% horizontal lines: middle
line(ax2,[bs_95(1,1) bs_95(1,2)],[bs_95(2,1) bs_95(2,1)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
line(ax2,[bs_95(1,1) bs_95(1,2)],[bs_95(2,2) bs_95(2,2)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
...
line(ax2,[bs_95(1,2) bs_95(1,2)],[ymin ymin + 0.03*(ymax-ymin) ], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
line(ax2,[bs_95(1,1) bs_95(1,1)],[ymax ymax - 0.03*(ymax-ymin) ], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
line(ax2,[bs_95(1,2) bs_95(1,2)],[ymax ymax - 0.03*(ymax-ymin) ], ...
    'linestyle','-','linewidth',linewdth_intervals2,'color', ...
    unif_intervals);
% add text about percentiles
if text_perct == 1
    hp = text(ax2,bs_95(1,1)+0.0002,ymin+0.035*(ymax-ymin),'${\rm 2.5\%}$', ...
        ...
        'HorizontalAlignment', 'left','color',unif_intervals);
    set(hp,'rotation',90);
    hp = text(ax2,bs_95(1,2)+0.0002,ymax-0.035*(ymax-ymin), ...
        '${\rm 97.5\%}$','interpreter','latex','fontsize',...
        fontsize_percentiles,'HorizontalAlignment', 'left', ...
        'color',unif_intervals);
    set(hp,'rotation',270);
...
% vertical lines: middle
line(ax2,[bs_95(1,1) bs_95(1,1)],[bs_95(2,1) bs_95(2,2)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
line(ax2,[bs_95(1,2) bs_95(1,2)],[bs_95(2,1) bs_95(2,2)],'linestyle', ...
    linewdth_type,'linewidth',linewdth_intervals,'color',unif_intervals);
...
text(ax2,xmin+0.016*(xmax-xmin),ymin+1.05*(ymax-ymin), ...
    '(B) Bootstrap: Approximation','fontsize',fontsize_labels);
% adjust figure
    ...
    switch z
        case 5
            plot(ax2,x_leg+0.0013,y_leg+0.01,'rx','markersize',15, ...
                'linewidth',2);
            text(ax2,x_legtext,y_legtext+0.01,'${\rm least\;squares}$', ...
                'interpreter','latex','fontsize',fontsize_axis, ...
                'color','r');
        case 6
